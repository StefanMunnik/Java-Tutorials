...
public class JavaTutorialThree{
	...
	public static void makeMultiplicationArray(){					//Method to make the create the correct answer
	...
	public static void testIfCorrect(){								//Test if the answer (guess) inputted from user is correct
	...
	public static void main(String[] args){
		JavaTutorialThree Obj = new JavaTutorialThree();
