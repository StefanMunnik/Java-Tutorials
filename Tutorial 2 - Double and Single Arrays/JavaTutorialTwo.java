...
public class JavaTutorialTwo{
	...
	public static void StoreSingleArrayValues(){					//Method to store values into the single array
	...
	public static void printSingleArray(){							//Self explanetory
	...
	public static void StoreDoubleArrayValues(){					//Method to store values 1 to 12 into the columns at index 0 and 1
	...
	public static void printDoubleArray(){							//Print the double array
	...
	public static void main(String[] args){
		JavaTutorialTwo Obj = new JavaTutorialTwo();
